...
-   [Install](#install)
    ...
    -   [Features](#features)
    -   [Details](#details)
            tools](#interop-with-outside-tools)
...
│                                                                              │
│ ╭────────────────── locals ───────────────────╮                              │
│ │ config_file = PosixPath('/tmp/tmp9iuwcxby') │                              │
│ │       njobs = 1                             │                              │
│ ╰─────────────────────────────────────────────╯                              │
│                                                                              │
...
│                                                                              │
│ ╭───────────────────────────────── locals ─────────────────────────────────╮ │
│ │    config = <fspathtree.fspathtree.fspathtree object at 0x759f8ae96cf0>  │ │
│ │     cycle = [                                                            │ │
...
│ │         G = <networkx.classes.digraph.DiGraph object at 0x759f5572b080>  │ │
│ │ make_copy = True                                                         │ │
