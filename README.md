...
│                                                                              │
│ ╭────────────────── locals ───────────────────╮                              │
│ │ config_file = PosixPath('/tmp/tmpmbxfkj33') │                              │
│ │       njobs = 1                             │                              │
│ ╰─────────────────────────────────────────────╯                              │
│                                                                              │
...
│                                                                              │
│ ╭───────────────────────────────── locals ─────────────────────────────────╮ │
│ │    config = <fspathtree.fspathtree.fspathtree object at 0x7adafdd90770>  │ │
│ │     cycle = [                                                            │ │
...
│ │         G = <networkx.classes.digraph.DiGraph object at 0x7adafde319d0>  │ │
│ │ make_copy = True                                                         │ │
